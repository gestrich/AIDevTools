...
struct AIDevToolsKit: AsyncParsableCommand {
    ...
    static let configuration = CommandConfiguration(
        ...
        subcommands: [ArchPlannerCommand.self, ChatCommand.self, ClearArtifactsCommand.self, ConfigCommand.self, ListCasesCommand.self, PlanRunnerCommand.self, ReposCommand.self, RunEvalsCommand.self, ShowOutputCommand.self, SkillsCommand.self]
    )
