...
- [x] Check `AIDevToolsKitMac/Models/CredentialModel.swift` and corresponding `CredentialsCommand.swift` for parity
  <!-- review: ShowCredentialCommand was bypassing the feature layer by calling settingsService.loadGitHubAuth and loadAnthropicKey directly from the Apps layer; replaced with LoadCredentialStatusUseCase and removed the unused masked/maskedLoad helpers. -->
